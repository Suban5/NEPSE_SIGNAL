...
def run_market_backtest_workflow(
    ...
    try:
        ...
        failure = classify_workflow_exception("market_backtest", "scan", exc)
        log_workflow_event(
            workflow="market_backtest",
            execution_id=execution_id,
            event="stage_failed",
    ...
    try:
        ...
        failure = classify_workflow_exception("market_backtest", "score", exc)
        log_workflow_event(
            workflow="market_backtest",
            execution_id=execution_id,
            event="stage_failed",
    ...
    try:
        ...
        failure = classify_workflow_exception("market_backtest", "rank", exc)
        log_workflow_event(
            workflow="market_backtest",
            execution_id=execution_id,
            event="stage_failed",
